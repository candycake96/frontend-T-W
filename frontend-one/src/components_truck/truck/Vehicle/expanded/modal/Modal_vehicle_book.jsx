                    ...
                    <div className="col-lg-5">
                        ...
                        <table className="table table-striped">
                            <tr >
                                ...
                                <td className="text-end">{dataTruck?.car_type_name}</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-card-checklist"></i></td>
                                <td>ยี่ห้อ</td>
                                <td className="text-end">{dataTruck?.car_brand}</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-card-checklist"></i></td>
                                <td>รุ่น</td>
                                <td className="text-end">{dataTruck?.model_no}</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-card-checklist"></i></td>
                                <td>เลขต้วรถ</td>
                                <td className="text-end">{dataTruck?.chassis_number}</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-card-checklist"></i></td>
                                <td>ปี</td>
                                <td className="text-end">{dataTruck?.reg_date}</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-card-checklist"></i></td>
                                <td>จำนวนที่นั่ง</td>
                                <td className="text-end">{dataTruck?.rights_to_use}</td>
                            </tr>
                            <tr>
                                <td><i class="bi bi-card-checklist"></i></td>
                                <td>สี</td>
                                <td className="text-end">{dataTruck?.color}</td>
                            </tr>
                        </table>
                    </div>
                </div>
