...
const validateForm = () => {
  ...
  // ถ้า car_type_id === "2" ให้ตั้งค่า fields ที่ต้องการเป็น null
  if (formData.car_type_id === "2") {
    formData.engine_brand = null;
    formData.engine_no = null;
    formData.engine_on_location = null;
    formData.cylinders = null;
    formData.engine_power = null;
  }
