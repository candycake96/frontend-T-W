...
const Modal_pending = ({isOpen, onClose}) => {
    ...
    return (
        ...
        >
            {/* Header */}
            <div
                className="modal-header bg-warning bg-opacity-10 border-bottom"
                style={{
                    padding: "1rem 1.5rem",
                    position: "sticky",
                    top: 0,
            ...
            >
                <h5 className="modal-title fw-bold text-warning m-0">🛠️ อยู่ระหว่างการดำเนินการ</h5>
